...
* [google_compute_target_https_proxy](https://www.terraform.io/docs/providers/google/r/compute_target_https_proxy.html) in the _Terraform Provider Documentation_