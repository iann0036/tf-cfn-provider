...
* [google_monitoring_uptime_check_config](https://www.terraform.io/docs/providers/google/r/monitoring_uptime_check_config.html) in the _Terraform Provider Documentation_