...
* [google_storage_object_access_control](https://www.terraform.io/docs/providers/google/r/storage_object_access_control.html) in the _Terraform Provider Documentation_