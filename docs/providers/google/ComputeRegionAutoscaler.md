...
* [google_compute_region_autoscaler](https://www.terraform.io/docs/providers/google/r/compute_region_autoscaler.html) in the _Terraform Provider Documentation_