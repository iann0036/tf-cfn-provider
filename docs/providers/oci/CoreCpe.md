...
`CompartmentId` - (Required) The OCID of the compartment to contain the CPE.
...
`IpAddress` - (Required) The public IP address of the on-premises router.  Example: `143.19.23.16`.
