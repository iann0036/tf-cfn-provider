...
`RequestPayer` - (Optional) Specifies who should bear the cost of Amazon S3 data transfer.
...
`SseKmsEncryptedObjects` - (Optional) Match SSE-KMS encrypted objects (documented below). If specified, `ReplicaKmsKeyId`
