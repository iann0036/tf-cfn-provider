...
THIRD_PARTY_PROVIDERS = [
	["Jira", "Jira", "https://github.com/iann0036/static-files/raw/master/terraform-provider-jira"]
]
...
""".format(
    ...
    for tpp in THIRD_PARTY_PROVIDERS:
        if tpp[1].lower() == provider_name:
            ...
            print(check_call(['curl', '-L', tpp[2], '-o', '/tmp/terraform-provider-' + provider_name], '/tmp/'))
            print(check_call(['chmod', '+x', '/tmp/terraform-provider-' + provider_name], '/tmp/'))
